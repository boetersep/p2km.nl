...
public class NoAbbrCapcodeInfoDecorator extends CapcodeInfo {
	...
	public NoAbbrCapcodeInfoDecorator(CapcodeInfo decoratedCapcodeInfo, AbbreviationsService abbreviationsService) {
	...
	public String getDescription() {
		return abbreviationsService.translate(decoratedCapcodeInfo.getDescription());
	}
	...
	public String toString() {
		return "NoAbbrCapcodeInfoDecorator [decoratedCapcodeInfo=" + decoratedCapcodeInfo + ", abbreviationsService="
