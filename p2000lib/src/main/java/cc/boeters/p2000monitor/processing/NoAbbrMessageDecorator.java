...
public class NoAbbrMessageDecorator extends Message {
	...
	public NoAbbrMessageDecorator(Message decoratedMessage,
	...
	public CapcodeInfo getCapcodeInfo() {
		if (decoratedMessage.getCapcodeInfo() != null) {
			return new NoAbbrCapcodeInfoDecorator(
					decoratedMessage.getCapcodeInfo(), abbreviationsService);
		}
	...
	public List<CapcodeInfo> getGroup() {
		...
		List<CapcodeInfo> translatedGroup = new ArrayList<CapcodeInfo>(
				decoratedGroup.size());
		for (CapcodeInfo decoratedCapcodeInfo : decoratedGroup) {
			translatedGroup.add(new NoAbbrCapcodeInfoDecorator(
	...
	public Map<String, Object> getMetadata() {
		return decoratedMessage.getMetadata();
	}
	...
	public String toString() {
		return "NoAbbrMessageDecorator [decoratedMessage=" + decoratedMessage
				+ ", abbreviationsService=" + abbreviationsService + "]";
	}
