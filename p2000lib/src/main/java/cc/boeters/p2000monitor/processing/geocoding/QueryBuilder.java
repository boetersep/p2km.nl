...
public abstract class QueryBuilder {
	...
	public QueryBuilder mapColumn(String column, MatchType matchType,
			String value) {
	...
	public QueryBuilder mapColumn(String column, MessageSource messageSource,
			Message message, MatchType matchType) {
	...
	public QueryBuilder mapValue(String value, MatchType matchType,
			String column) {
